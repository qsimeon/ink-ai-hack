...
import { hasActiveCadAnimations } from '../elements/cadsketch/renderer';
...
export function InkCanvas({
  ...
  const render = useCallback((timestamp?: number) => {
    ...
    if (hasActiveAnimations || hasGenerating || hasActiveImageTransitions() || hasActiveTicTacToeAnimations() || hasActiveCadAnimations()) {
